"""Generator service for Multimodal RAG."""

from langchain_core.prompts import ChatPromptTemplate
from langchain_ollama import ChatOllama

from multimodal_rag.config import MultimodalRAGConfig
from multimodal_rag.exceptions import GenerationError
...
The context may include text extracted from images.
...
Answer:"""
    ...
    def generate(
        self,
        question: str,
        context: list[MultimodalQueryResult],
    ) -> str:
